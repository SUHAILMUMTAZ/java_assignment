...
class BankAccountSystem {
 ...
 public BankAccountSystem(String accountNumber, String accountHolder, double 
initialBalance) {
...
public class BankAccManagement{
 ...
 BankAccountSystem account1 = new BankAccountSystem("123456", "SUHAIL", 5000);
 BankAccountSystem account2 = new BankAccountSystem("789012", "BASIT", 10000);
